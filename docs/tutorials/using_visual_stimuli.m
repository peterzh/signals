...
% The visual stimulus object is the ~th input to an experiment definition.
% It is a StructRef object, which like a structure, can be assigned fields.
...
% <./hardware_config.html#27 hardware_config>:
root = fileparts(which('addRigboxPaths'));
opentoline(fullfile(root, 'docs', 'setup', 'hardware_config.m'), 344, 1)
...
% the vertices to homogeneous coordinates (vec4), i.e. position = [position
% 1]; See slimshady.vert
%
