function testDef(t, evts, p, vs, in, out, audio)
%% advancedChoiceWorld
...
% stimulusDisplacement = iff(stimulusDisplacement >= p.border * correctResponse, ...
%   p.border * correctResponse, stimulusDisplacement);
stimulusDisplacement.Node.Listeners = output(stimulusDisplacement);
