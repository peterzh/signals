...
minSamples = round(0.015*audioSR); %minimum number of samples to output
...
audh = audstream.fromSignal(tones, audioSR, 3); % put the tones into the stream
